      ...
      <div>
        ...
        <div className="container">
          ...
          <div className="row mb-5 mt-5">
            <div className="col-lg-4 col-sm-12 order-lg-first order-sm-first text-center align-self-center">
              <img width="200px" height="200px"src={require("../assets/logos/leo_red.svg")} alt="Leo Alpha"></img>
            </div>
            <div className="col-lg-8 col-sm-12">
              <h2 className="display-4 mb-5 mt-5 text-lg-left text-sm-center">What is Leo Club?</h2>
          ...
          <div className="row mb-5 mt-5">
            <div className="col-lg-8 col-sm-12">
              <h2 className="display-4 mb-5 mt-5 text-lg-left text-sm-center">Our History</h2>
            ...
            <div className="col-lg-4 col-sm-12 order-lg-last order-sm-first text-center align-self-center">
          ...
          <div className="row mb-5 mt-5">
            ...
            <div className="col-lg-8 col-sm-12">
              <h2 className="display-4 mb-5 mt-5 text-lg-left text-sm-center">Why join our club?</h2>
