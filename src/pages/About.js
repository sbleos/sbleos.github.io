      ...
      <div>
        ...
        <div className="container">
          ...
          <div className="row mb-5 mt-5">
            <div className="col-md-4 col-xs-12 order-md-first order-xs-first text-center align-self-center">
              <img width="200px" height="200px"src={require("../assets/logos/leo_red.svg")} alt="Leo Alpha"></img>
            </div>
            <div className="col-md-8 col-xs-12 text-md-left text-xs-center">
          ...
          <div className="row mb-5 mt-5">
            ...
            <div className="col-md-4 col-xs-12 order-md-last order-xs-first text-center align-self-center">
