      ...
      <div>
        ...
        <div className="jumbotron jumbotron-fluid " style={{background:`linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(${require("../assets/home/home_2.jpg")})`,backgroundPosition:"center",backgroundSize:"cover"}}>
          <div className="container">
            <div className="row">
              <div className="col-md-7 text-md-left text-xs-center" style={{color:"#F9C910","textShadow": "2px 2px 0px #000000"}}>
              ...
              <div className={`col-md-4 col-xs-12 ${this.props.auth.isEmpty ? "visible" : "invisible"}`}>
